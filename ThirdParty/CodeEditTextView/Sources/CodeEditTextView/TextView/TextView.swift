...
open class TextView: NSView, NSTextContent {
    ...
    /// The fixed document offset and view point where a mouse selection began.
    /// The point is retained for rectangular selections; normal selections use the stable document offset.
    var mouseDragAnchor: CGPoint?
    var mouseDragAnchorOffset: Int?
    var mouseDragPublishedRanges: [NSRange]?
    var mouseDragSelectionDidChange = false
