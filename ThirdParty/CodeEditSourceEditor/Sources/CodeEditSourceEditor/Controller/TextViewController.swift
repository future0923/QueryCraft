...
public class TextViewController: NSViewController {
    ...
    /// The key that accepts the selected code-completion suggestion.
    public var completionAcceptanceKey: CompletionAcceptanceKey {
        configuration.behavior.completionAcceptanceKey
    }
    ...
    /// Space before the widest line number.
    public var gutterLeadingPadding: CGFloat { configuration.layout.gutterLeadingPadding }

    /// Minimum number of digits reserved by the line number gutter.
    public var gutterMinimumDigitCount: Int { configuration.layout.gutterMinimumDigitCount }
    ...
    public func setText(_ text: String) {
        ...
        self.gutterView?.foldingRibbon.model?.documentReplaced()
