...
extension SourceEditorConfiguration {
    public struct Behavior: Equatable {
        ...
        public var completionAcceptanceKey: CompletionAcceptanceKey = .returnOrTab
        ...
        public init(
            ...
            completionAcceptanceKey: CompletionAcceptanceKey = .returnOrTab
        ) {
            self.isEditable = isEditable
            self.isSelectable = isSelectable
            self.indentOption = indentOption
            self.reformatAtColumn = reformatAtColumn
            self.completionAcceptanceKey = completionAcceptanceKey
        }
