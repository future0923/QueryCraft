...
final class LineIndentationFoldProvider: LineFoldProvider {
    ...
    func foldLevelAtLine(
        ...
        // Fold depth is relative indentation, independent of the user's Tab
        // insertion preference. Server JSON often uses two spaces even when
        // the editor inserts four; integer division used to lose those folds.
